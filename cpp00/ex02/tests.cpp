...
int		main( void ) {
	...
	for ( std::pair<std::vector<Account>::iterator, std::vector<int>::iterator> it( acc_begin, dep_begin );
	...
	// Account::t is Account, since t is a typedef of Account
	for ( std::pair<std::vector<Account::t>::iterator, std::vector<int>::iterator> it( acc_begin, wit_begin );
